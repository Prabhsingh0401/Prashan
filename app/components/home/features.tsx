        ...
        <section id="features" className="w-full max-w-[1400px] mx-auto px-4 py-5 relative z-10 font-sans">
            ...
            <div className="flex flex-col items-center text-center mb-16">
                ...
                <p className="text-lg sm:text-xl text-foreground/60 max-w-2xl font-medium tracking-tight leading-relaxed mb-8">
                    Sign in, configure your paper, let AI draft and format every question in LaTeX — then export as PDF or Word in one click.
                </p>
            </div>
            ...
            ">
                ...
                {/* Cell 1 — Class › Subject › Chapters */}
                <div className="p-8 lg:p-10 border-b md:border-r border-white/50 dark:border-white/5
                            ...
                            {[
                                ...
                                <div key={row.label}
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="text-[10px] font-mono font-bold tracking-widest text-foreground/40 uppercase w-14">{row.label}</span>
                            ...
                            {[
                                ...
                                <div key={q.type}
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-semibold text-foreground">{q.type}</span>
                                        <span className="text-[10px] font-mono text-foreground/40 border border-black/8 dark:border-white/10 px-1.5 py-0.5 rounded-md">{q.marks}</span>
                                    </div>
                                    <span className="text-[11px] font-mono font-bold text-foreground/60">{q.count}</span>
                                </div>
                            ))}
                            {/* Total */}
                ...
                {/* Cell 3 — Header Builder */}
                <div className="p-8 lg:p-10 border-b border-white/50 dark:border-white/5
                    flex flex-col justify-between min-h-[320px] group
                    bg-white/20 dark:bg-white/[0.03]
                    hover:bg-white/30 dark:hover:bg-white/[0.05]
                    transition-colors duration-300
                ">
                    <div>
                        ...
                        <h3 className="text-xl font-bold text-foreground tracking-tight mb-5 leading-[1.2]">
                            Brand your paper <br />your way.
                        </h3>

                        {/* Header preview card */}
                        <div className="w-full rounded-2xl bg-white dark:bg-white/5 border border-black/8 dark:border-white/10
                            ...
                            <div className="px-4 py-3 flex items-center justify-between">
                                <span className="text-[10px] font-mono text-foreground/40">Time: 2 hrs &nbsp;|&nbsp; MM: 40</span>
                ...
                {/* Cell 4 — Curriculum Mapping */}
                <div className="p-8 lg:p-12 border-b md:border-b-0 md:border-r border-white/50 dark:border-white/5
                ...
                ">
                    <div>
                        <div className="flex items-center justify-between mb-8">
                            <span className="text-[10px] font-mono font-bold tracking-widest text-foreground/60 uppercase">Curriculum</span>
                        ...
                        <p className="text-foreground/60 text-[15px] leading-relaxed font-medium">
                            CBSE, ICSE, and all State Boards. Questions are automatically scoped to the exact chapters and difficulty levels you selected — no extra setup.
                        </p>
                    </div>
                    <div className="flex gap-2 mt-8 flex-wrap">
                        {["CBSE", "ICSE", "State Board"].map((b) => (
                            <span key={b} className="text-[10px] font-mono font-bold tracking-widest uppercase px-2.5 py-1 rounded-lg border border-black/8 dark:border-white/10 text-foreground/60 bg-white/60 dark:bg-white/5">
                                {b}
                            </span>
                        ))}
                    </div>
                ...
                ">
                    <div>
                        <div className="flex items-center justify-between mb-8">
                            <span className="text-[10px] font-mono font-bold tracking-widest text-foreground/60 uppercase">AI Engine</span>
                            <ArrowRight size={14} className="text-foreground/20 group-hover:text-foreground/60 transition-all group-hover:translate-x-1" />
                        </div>
                        <h3 className="text-2xl lg:text-3xl font-bold mb-4 text-foreground tracking-tight leading-[1.15]">
                        ...
                        <p className="text-foreground/60 text-[15px] leading-relaxed font-medium">
                            Questions are generated and instantly laid out — correct spacing, neat numbering, proper sections. Exactly how a printed paper should look, automatically.
                        </p>
                    </div>
                    {/* Formatted question preview */}
                    <div className="mt-8 rounded-xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 px-4 py-3 text-[12px] text-foreground/60 leading-relaxed overflow-hidden space-y-1.5">
                        <p className="font-bold text-foreground/80 text-[11px] tracking-widest uppercase font-mono">Section B — Short Answer</p>
                        <p><span className="font-semibold text-foreground">Q1.</span> Find the roots of x² − 5x + 6 = 0. <span className="text-foreground/30">[3 marks]</span></p>
                        <p><span className="font-semibold text-foreground">Q2.</span> State and prove the mid-point theorem. <span className="text-foreground/30">[3 marks]</span></p>
                        <p className="flex items-center gap-1 text-foreground/30">
                            Q3. Generating<span className="inline-block w-1.5 h-3 bg-foreground/30 animate-pulse ml-0.5" />
                        </p>
                    </div>
                </div>

                {/* Cell 6 — Live Edit & Export */}
                <div className="p-8 lg:p-12 flex flex-col justify-between group cursor-pointer
                ...
                ">
                    <div>
                        <div className="flex items-center justify-between mb-8">
                            <span className="text-[10px] font-mono font-bold tracking-widest text-foreground uppercase">Export</span>
                        ...
                        <p className="text-foreground/60 text-[15px] leading-relaxed font-medium">
                            Review and tweak every question in the live editor. When you're happy, export a print-ready PDF or editable Word file instantly.
                        </p>
                    </div>
                    {/* Export action pills */}
