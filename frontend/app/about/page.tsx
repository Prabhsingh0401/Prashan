...
const organizationJsonLd = {
  ...
  mainEntity: {
    ...
    name: "Prashan",
    description:
      "Prashan is an AI-powered question paper generator built for Indian teachers. Our platform creates board-aligned, professionally formatted exam papers in under minutes.",
    foundingDate: "2024",
              ...
              <div className="pt-4 border-t border-foreground/10">
                ...
                <ul className="space-y-2 text-base text-foreground/60">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Curriculum-aligned questions for CBSE (ICSE & State Boards coming soon)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-foreground">✓</span>
